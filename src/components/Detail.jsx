...
/**
 * Detail component that displays detailed information about a movie or an actor.
 * 
 * If an actor's ID is provided in the URL parameters, it shows the details of that actor,
 * including their name, biography, and image. If no actor is found, an error message is displayed.
 * 
 * If no actor ID is provided, it displays the details of the movie, including its name, summary,
 * poster image, and a list of actors. Each actor in the list is a link that navigates to their
